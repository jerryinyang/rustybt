...
from rustybt.api import get_environment, order, symbol
...
record_variables = """
from rustybt.api import record
...
empty_positions = """
from rustybt.api import record, schedule_function, time_rules, date_rules, \
    symbol
...
set_benchmark_algo = """
from rustybt.api import symbol, set_benchmark
