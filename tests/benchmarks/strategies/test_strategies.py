...
def test_simple_sma_crossover_deterministic():
    ...
    from .simple_sma_crossover import create_initialize_fn, create_handle_data_fn
...
def test_momentum_strategy_deterministic():
    ...
    from .momentum_strategy import create_initialize_fn, create_handle_data_fn
...
def test_multi_indicator_strategy_deterministic():
    ...
    from .multi_indicator_strategy import create_initialize_fn, create_handle_data_fn
...
def test_strategy_imports():
    ...
    from . import SimpleSMACrossover, MomentumStrategy, MultiIndicatorStrategy
