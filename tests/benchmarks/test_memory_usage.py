...
def test_memory_daily_simple_10_assets():
    ...
    # Import strategies
    from .strategies.simple_sma_crossover import create_initialize_fn, create_handle_data_fn
    from .test_backtest_performance import run_backtest_benchmark, fixture_exists
...
def test_memory_hourly_medium_50_assets():
    ...
    from .strategies.momentum_strategy import create_initialize_fn, create_handle_data_fn
    from .test_backtest_performance import run_backtest_benchmark, fixture_exists
...
def test_memory_daily_complex_100_assets():
    ...
    from .strategies.multi_indicator_strategy import create_initialize_fn, create_handle_data_fn
    from .test_backtest_performance import run_backtest_benchmark, fixture_exists
