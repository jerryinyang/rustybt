...
class TestCmdLine:
    ...
    def test_user_input(self):
        rustybt.extension_args = Namespace()
        ...
        assert rustybt.extension_args.first.second.a == "blah1"
        assert rustybt.extension_args.first.second.b == "blah2"
        assert rustybt.extension_args.first.third == "blah3"
        assert rustybt.extension_args.second.a.b == "blah4"
        assert rustybt.extension_args.second.b.a == "blah5"
        assert rustybt.extension_args.a1 == "value1"
        assert rustybt.extension_args.b_ == "value2"
